import{a as C,b as E,c as y,d as z,e as P,h as f,i as H,l as T,m as L}from"./chunk-HCOZCCMD.js";import{a as p,b as w,e as h}from"./chunk-CW4BMCRM.js";var R=h(C());var c=h(C());var e=h(C());var V=0,$=600,A=t=>{let a=(0,e.useRef)([0,0]),o=(0,e.useRef)([0,0]),r=(0,e.useRef)([0,0]),d=(0,e.useRef)(null),n=(0,e.useMemo)(()=>y(t.containerSize,"desktop"),[t.containerSize]),[l,s]=(0,e.useState)(null),[b,m]=P({rotateX:0,rotateY:0,backgroundColor:l?"rgba(250, 204, 21,0.9)":"rgba(250, 204, 21,0.1)",scale:l?1.3:1,borderRadius:l?"1%":"50%",config:w(p({},z.wobbly),{clamp:!0})},[l]),g=(0,e.useCallback)(u=>{o.current=[u.pageX,u.pageY];let[v,S]=E(u.pageX,u.pageY,r.current[0],r.current[1],45);m.start({rotateX:v,rotateY:S})},[]),x=(0,e.useCallback)(()=>{let u=window.scrollX-a.current[0],v=window.scrollY-a.current[1];o.current=[u+o.current[0],v+o.current[1]];let[S,k]=E(o.current[0],o.current[1],r.current[0],r.current[1],45);a.current=[window.scrollX,window.scrollY],m.start({rotateX:S,rotateY:k})},[]);(0,e.useEffect)(()=>(setTimeout(()=>{if(d.current){let{left:S,top:k}=d.current.getBoundingClientRect();r.current=[S+window.scrollX+n.containerSize/2,k+window.scrollY+n.containerSize/2],a.current=[window.scrollX,window.scrollY]}o.current=[r.current[0],r.current[1]];let[u,v]=E(o.current[0],o.current[1],r.current[0],r.current[1],45);m.start({rotateX:u,rotateY:v})},350),window.addEventListener("mousemove",g,{passive:!0}),window.addEventListener("scroll",x,{passive:!0}),()=>{window.removeEventListener("mousemove",g),window.removeEventListener("scroll",x)}),[]);let I=(0,e.useCallback)(()=>{t.onMouseOverHandler&&t.onMouseOverHandler(),s(!0)},[]),Z=(0,e.useCallback)(()=>{t.onMouseOutHandler&&t.onMouseOutHandler(),s(!1)},[]),G=(0,e.useCallback)(u=>{t.onClickHandler(u)},[]);return e.default.createElement("div",{ref:d,className:"relative flex justify-center items-center",style:{width:n.containerSize,height:n.containerSize}},e.default.createElement(f.div,{className:`\r
        relative\r
        [&>div]:absolute \r
        [&>div]:w-full \r
        [&>div]:h-full \r
